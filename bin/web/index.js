...
// end include: /tmp/tmpa3aiqliu.js
// include: /tmp/tmpr7hqie3r.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpr7hqie3r.js
// include: /tmp/tmplropimge.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmplropimge.js
...
var ASM_CONSTS = {
 ...
 95812: () => { return parseInt(Module.canvas.style.width); },  
 95860: () => { document.exitFullscreen(); },  
 95887: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 95959: () => { if (document.fullscreenElement) return 1; },  
 96005: () => { return Module.canvas.width; },  
 96037: () => { return screen.width; },  
 96062: () => { document.exitFullscreen(); },  
 96089: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 96283: () => { return window.innerWidth; },  
 96309: () => { return window.innerHeight; },  
 96336: () => { if (document.fullscreenElement) return 1; },  
 96382: () => { return Module.canvas.width; },  
 96414: () => { return parseInt(Module.canvas.style.width); },  
 96462: () => { if (document.fullscreenElement) return 1; },  
 96508: () => { return Module.canvas.width; },  
 96540: () => { return screen.width; },  
 96565: () => { return window.innerWidth; },  
 96591: () => { return window.innerHeight; },  
 96618: () => { if (document.fullscreenElement) return 1; },  
 96664: () => { return Module.canvas.width; },  
 96696: () => { return screen.width; },  
 96721: () => { document.exitFullscreen(); },  
 96748: () => { if (document.fullscreenElement) return 1; },  
 96794: () => { return Module.canvas.width; },  
 96826: () => { return parseInt(Module.canvas.style.width); },  
 96874: () => { document.exitFullscreen(); },  
 96901: ($0) => { Module.canvas.style.opacity = $0; },  
 96939: () => { return screen.width; },  
 96964: () => { return screen.height; },  
 96990: () => { return window.screenX; },  
 97017: () => { return window.screenY; },  
 97044: () => { return window.devicePixelRatio; },  
 97080: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 97133: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 97184: () => { Module.canvas.style.cursor = 'none'; },  
 97221: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 97477: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 97528: () => { if (document.pointerLockElement) return 1; },  
 97575: () => { if (document.fullscreenElement) return 1; },  
