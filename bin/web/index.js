...
var ASM_CONSTS = {
  141182: () => { if (document.fullscreenElement) return 1; },  
 141228: () => { return Module.canvas.width; },  
 141260: () => { return parseInt(Module.canvas.style.width); },  
 141308: () => { document.exitFullscreen(); },  
 141335: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 141407: () => { if (document.fullscreenElement) return 1; },  
 141453: () => { return Module.canvas.width; },  
 141485: () => { return screen.width; },  
 141510: () => { document.exitFullscreen(); },  
 141537: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 141731: () => { return window.innerWidth; },  
 141757: () => { return window.innerHeight; },  
 141784: () => { if (document.fullscreenElement) return 1; },  
 141830: () => { return Module.canvas.width; },  
 141862: () => { return parseInt(Module.canvas.style.width); },  
 141910: () => { if (document.fullscreenElement) return 1; },  
 141956: () => { return Module.canvas.width; },  
 141988: () => { return screen.width; },  
 142013: () => { return window.innerWidth; },  
 142039: () => { return window.innerHeight; },  
 142066: () => { if (document.fullscreenElement) return 1; },  
 142112: () => { return Module.canvas.width; },  
 142144: () => { return screen.width; },  
 142169: () => { document.exitFullscreen(); },  
 142196: () => { if (document.fullscreenElement) return 1; },  
 142242: () => { return Module.canvas.width; },  
 142274: () => { return parseInt(Module.canvas.style.width); },  
 142322: () => { document.exitFullscreen(); },  
 142349: ($0) => { Module.canvas.style.opacity = $0; },  
 142387: () => { return screen.width; },  
 142412: () => { return screen.height; },  
 142438: () => { return window.screenX; },  
 142465: () => { return window.screenY; },  
 142492: () => { return window.devicePixelRatio; },  
 142528: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 142581: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 142632: () => { Module.canvas.style.cursor = 'none'; },  
 142669: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 142925: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 142976: () => { if (document.pointerLockElement) return 1; },  
 143023: () => { if (document.fullscreenElement) return 1; },  
 143069: () => { return window.innerWidth; },  
 143095: () => { return window.innerHeight; }
};
